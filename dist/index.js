...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const type = core.getInput('distribution-set-type');
            const name = core.getInput('distribution-set-name');
            const version = core.getInput('distribution-set-version');
            const softwareModuleIds = core.getInput('software-module-ids');
            const modules = softwareModuleIds.split(',').map(value => {
                return {
                    id: parseInt(value.trim())
                };
            });
            const distributionSet = yield api_1.createDistributionSet({
                type,
                name,
                version,
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createDistributionSet = void 0;
const core = __importStar(__webpack_require__(186));
...
function createDistributionSet(distributionSet) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            core.error(`Failed creating distribution set ${error} ${JSON.stringify(error.response.data)}`);
            return null;
        }
    });
}
